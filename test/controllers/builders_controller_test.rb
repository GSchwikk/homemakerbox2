...
class BuildersControllerTest < ActionController::TestCase
  ...
  test "should create builder" do
    assert_difference('Builder.count') do
      post :create, builder: { address: @builder.address, name: @builder.name, phone: @builder.phone, website: @builder.website }
    end
  ...
  test "should update builder" do
    patch :update, id: @builder, builder: { address: @builder.address, name: @builder.name, phone: @builder.phone, website: @builder.website }
    assert_redirected_to builder_path(assigns(:builder))
  end
